...
> = Hono<{ Bindings: Env }, S, BasePath>

export function defineFetchApp<
  Env extends object,
  App extends FetchApp<Env> = FetchApp<Env>,
  CfHostMetadata = unknown,
>(app: (app: FetchApp<Env>) => App): ExportedHandlerFetchHandler<Env, CfHostMetadata> {
...
export function defineWorkerHandlers<
  ...
  CfHostMetadata = unknown,
>(
  options: DefineWorkerHandlersOptions<Env, QueueMessage, App>,
